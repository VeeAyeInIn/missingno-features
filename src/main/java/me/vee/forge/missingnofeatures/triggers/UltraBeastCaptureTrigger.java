...
/**
 * Used in conjunction with {@link me.vee.forge.missingnofeatures.handlers.UltraBeastCaptureHandler}, to activate once a
 * Pixelmon has been caught, and is confirmed to be an Ultra Beast.
 *
...
public class UltraBeastCaptureTrigger implements ICriterionTrigger<UltraBeastCaptureTrigger.Instance> {
    ...
    private static final ResourceLocation ID = new ResourceLocation(MissingNoFeatures.MOD_ID + ":ultrabeast_capture_trigger");
